...
\todo{implement cycle regularization for classic parameterization optimization and shape deformation to show that it is a general regularization technique as any classic regularization term that can be used beyond training neural networks}
