...
%introduction to surface reconstruction networks
Inferring 3D shapes with neural network is now studied by the 
%advantage and shortage of the chamfer distance loss
