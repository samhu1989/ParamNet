...
\done{Try randomly sample points from surface, so that the injective is better extended to the entire surface}
 
\todo{tune the super parameters for lower cd loss as well as keeping the self-intersection significantly reduced}
