...
\begin{m_def}
\label{def:injective}
\mdf{Let $f$ be a function whose domain is a set $X$. The function $f$ is said to be injective provided that}
\iffalse
\begin{equation}
