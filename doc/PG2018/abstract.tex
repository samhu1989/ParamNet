\begin{abstract}
	...
	While mesh \cxj{or surface} models are widely used in many applications, it is challenging to apply the successful deep neural networks to directly produce surface models.  
	\cxj{Are we the first to directly produce a mesh model from an image using DNN? }
	Unlike the existing methods that use volumetric or point representations, our method represents a 3D shape by a mapping from a fixed parameter domain. 
	%
