...
In this subsection, we do ablation study to investigate the functionality of each components in our framework. The evaluation are shown in Table~\ref{tab:ablation} and Table~\ref{tab:} 
...
The normal loss suppress triangle flipping by using the normal from groundtruth to guide the learning. 
